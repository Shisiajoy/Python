def find_highest_priced_product(products):
    ...
    for product,price in products:     #for loop to iterate tru each dictionary in the list
        product_name = product["name"] #to extract names from each dictionary in the list
